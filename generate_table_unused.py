...
field2nice = {'absolute_file_paths': 'Absolute file paths',
...
fields_nice = [f"[*{field}*]" for field in fields_nice] 
...
data = { msg.language: [ "●" if getattr(msg, field) else "○" for field in field_names] for msg in stack_traces }
